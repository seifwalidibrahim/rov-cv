...
target_combined_width_pixels = 1280
target_combined_height_pixels = 480

class StereoCamera:
    def __init__(self, camera_device_index, target_combined_width_pixels, target_combined_height_pixels):
        self.stereo_video_capture_interface = cv2.VideoCapture(camera_device_index, cv2.CAP_DSHOW)
